...
attendance_df = pd.read_csv("C:/python prog/02_setup/attendance_logs.csv")
events_df = pd.read_csv("C:/python prog/02_setup/event_participation.csv")
lms_df = pd.read_csv("C:/python prog/02_setup/lms_usage.csv")
